...
---@alias game-Scripts-SaveLogic.RoomSaveWhitelist ...

function game.char(a) end
---@alias game-Scripts-SaveLogic.char ...

function game.eq(a) end
---@alias game-Scripts-SaveLogic.eq ...

function game.Load(a) end
---@alias game-Scripts-SaveLogic.Load ...

function game.pickle(a) end
---@alias game-Scripts-SaveLogic.pickle ...

function game.print_r(a) end
---@alias game-Scripts-SaveLogic.print_r ...

function game.Save() end
---@alias game-Scripts-SaveLogic.Save ...

function game.serializeString(a) end
---@alias game-Scripts-SaveLogic.serializeString ...

function game.shallow_copy(a) end
---@alias game-Scripts-SaveLogic.shallow_copy ...

function game.string_split(a, b) end
---@alias game-Scripts-SaveLogic.string_split ...

function game.StripRoomsForSave(a, b) end
---@alias game-Scripts-SaveLogic.StripRoomsForSave ...

function game.StripRunForSave(a, b) end
---@alias game-Scripts-SaveLogic.StripRunForSave ...

function game.StripRunHistoryForSave() end
---@alias game-Scripts-SaveLogic.StripRunHistoryForSave ...

function game.unpickle(a) end
---@alias game-Scripts-SaveLogic.unpickle ...

function game.Using(a) end
---@alias game-Scripts-SaveLogic.Using ...

function game.ValidateTypes(a, b, c, d) end
---@alias game-Scripts-SaveLogic.ValidateTypes ...
