...
function game.AttemptUseAutoExitDoor(a, b) end
---@alias game-Scripts-RoomLogic.AttemptUseAutoExitDoor ...

function game.AttemptUseDoor(a, b) end
---@alias game-Scripts-RoomLogic.AttemptUseDoor ...

function game.BeginArachneEncounter(a) end
---@alias game-Scripts-RoomLogic.BeginArachneEncounter ...

function game.BeginArtemisEncounter(a) end
---@alias game-Scripts-RoomLogic.BeginArtemisEncounter ...

function game.BeginAthenaEncounter(a) end
---@alias game-Scripts-RoomLogic.BeginAthenaEncounter ...

function game.BeginCrawlerEncounter(a) end
---@alias game-Scripts-RoomLogic.BeginCrawlerEncounter ...

function game.BeginEliteChallenge(a) end
---@alias game-Scripts-RoomLogic.BeginEliteChallenge ...

function game.BeginHeraclesEncounter(a) end
---@alias game-Scripts-RoomLogic.BeginHeraclesEncounter ...

function game.BeginIcarusEncounter(a) end
---@alias game-Scripts-RoomLogic.BeginIcarusEncounter ...

function game.BeginNemesisEncounter(a) end
---@alias game-Scripts-RoomLogic.BeginNemesisEncounter ...

function game.BeginOpeningEncounter(a) end
---@alias game-Scripts-RoomLogic.BeginOpeningEncounter ...

function game.BeginPerfectClearEncounter(a) end
---@alias game-Scripts-RoomLogic.BeginPerfectClearEncounter ...

function game.BlockExitUntilUsedIfElligible(a, b) end
---@alias game-Scripts-RoomLogic.BlockExitUntilUsedIfElligible ...
...
function game.CheckDoorHealTrait(a, b, c) end
---@alias game-Scripts-RoomLogic.CheckDoorHealTrait ...

function game.CheckExitPreUnlock(a, b, c) end
...
function game.CheckN_SubRoomDoorUnavailable(a, b) end
---@alias game-Scripts-RoomLogic.CheckN_SubRoomDoorUnavailable ...
...
function game.ClearUpgrades(a) end
...
function game.DoShadeMercActivations(a, b) end
---@alias game-Scripts-RoomLogic.DoShadeMercActivations ...
...
function game.EraseRoomKeys(a, b, c) end
---@alias game-Scripts-RoomLogic.EraseRoomKeys ...
...
function game.GetDoorHealAmount(a, b) end
...
function game.GetMaxHealthUpgradeIncrement(a, b) end
...
function game.GiveRandomConsumables(a, b, c) end
...
function game.HasRoomRequiredObject() end
---@alias game-Scripts-RoomLogic.HasRoomRequiredObject ...

function game.HasTraitOnLoot(a, b) end
---@alias game-Scripts-RoomLogic.HasTraitOnLoot ...

function game.InstantUseMoneyDrops() end
---@alias game-Scripts-RoomLogic.InstantUseMoneyDrops ...
...
function game.IsEliteChallengeForced(a) end
---@alias game-Scripts-RoomLogic.IsEliteChallengeForced ...

function game.IsEncounterActiveCombat(a, b) end
---@alias game-Scripts-RoomLogic.IsEncounterActiveCombat ...

function game.IsMetaRewardStandEligible(a, b) end
---@alias game-Scripts-RoomLogic.IsMetaRewardStandEligible ...

function game.IsPerfectClearChallengeForced(a) end
---@alias game-Scripts-RoomLogic.IsPerfectClearChallengeForced ...
...
function game.IsTimeChallengeForced(a) end
---@alias game-Scripts-RoomLogic.IsTimeChallengeForced ...
...
function game.LoadBountyPackages(a) end
---@alias game-Scripts-RoomLogic.LoadBountyPackages ...

function game.LoadCurrentRoomResources(a) end
---@alias game-Scripts-RoomLogic.LoadCurrentRoomResources ...

function game.LoadSpawnPackages(a) end
---@alias game-Scripts-RoomLogic.LoadSpawnPackages ...

function game.LoadVoiceBanks(a, b, c) end
...
function game.PassRarityCheck(a) end
---@alias game-Scripts-RoomLogic.PassRarityCheck ...

function game.PickEncounterEliteAttributes(a) end
---@alias game-Scripts-RoomLogic.PickEncounterEliteAttributes ...

function game.PickRoomEliteAttributes(a) end
---@alias game-Scripts-RoomLogic.PickRoomEliteAttributes ...
...
function game.RemoveInspectPoints() end
---@alias game-Scripts-RoomLogic.RemoveInspectPoints ...
...
function game.SelectRoomRewardSpawnPoint(a, b) end
...
function game.SetDepletedAnimIfUnuseable(a, b) end
---@alias game-Scripts-RoomLogic.SetDepletedAnimIfUnuseable ...
...
function game.SetupComboPartners(a) end
---@alias game-Scripts-RoomLogic.SetupComboPartners ...

function game.SetupDefaultDoor(a, b) end
---@alias game-Scripts-RoomLogic.SetupDefaultDoor ...

function game.SetupHeroForEnding() end
---@alias game-Scripts-RoomLogic.SetupHeroForEnding ...
...
function game.SetupUnitOutline(a, b) end
---@alias game-Scripts-RoomLogic.SetupUnitOutline ...
...
function game.SpawnObstaclesOnUnit(a, b) end
---@alias game-Scripts-RoomLogic.SpawnObstaclesOnUnit ...
...
function game.TyphonEyeEggFuser(a, b) end
---@alias game-Scripts-RoomLogic.TyphonEyeEggFuser ...
...
function game.UnusedWeaponBonusDropGems(a, b) end
---@alias game-Scripts-RoomLogic.UnusedWeaponBonusDropGems ...

function game.UnusedWeaponBonusReward() end
---@alias game-Scripts-RoomLogic.UnusedWeaponBonusReward ...

function game.UpdateHubRewardLookup() end
---@alias game-Scripts-RoomLogic.UpdateHubRewardLookup ...

function game.UseableOnDelay(a, b) end
---@alias game-Scripts-RoomLogic.UseableOnDelay ...
