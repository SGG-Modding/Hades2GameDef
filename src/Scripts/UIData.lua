...
game.NativeScreenCenterX = 960
---@alias game-Scripts-UIData.NativeScreenCenterX ...

game.NativeScreenCenterY = 540
---@alias game-Scripts-UIData.NativeScreenCenterY ...

game.NativeScreenHeight = 1080
---@alias game-Scripts-UIData.NativeScreenHeight ...

game.NativeScreenWidth = 1920
---@alias game-Scripts-UIData.NativeScreenWidth ...
...
---@class game-Scripts-UIData*DoomContextArtLayers

---@type game-Scripts-UIData*DoomContextArtLayers
game.DoomContextArtLayers = ...
---@alias game-Scripts-UIData.DoomContextArtLayers ...
